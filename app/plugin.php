...
class Plugin {
	...
	private function loadDependencies() {
		 ...
		 */
		require_once $plugin_dir_path . 'app/load-texdomain.php';
	...
	private function setLocale() {
		$plugin_load_texdomain = new LoadTexdomain();
		$this->loader->add_action( 'plugins_loaded', $plugin_load_texdomain, 'loadPluginTextdomain' );
	}
